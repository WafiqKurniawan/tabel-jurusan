...
<header>
 ...
 <li class="nav-item">
 <a class="nav-link disabled" href="{{url('/mapel')}}"><font color="white">MAPEL</font> <span class="sr-only">(current)</span></a>
 </li>
